% platex -> dvipdfmx で可能
% Created by: Jmol 14.2.4_2014.08.03  2014-08-03 08:56
% Creation date: Wed, 24 9 2014 15:54:32 +0900
% File created: c:/users/ユーザ名/desktop/100d.idtf (289879 bytes)
...
\usepackage{verbatim}
\pagestyle{empty}
\title{動く3D分子模型の取り込み（Jmol使用）}
\author{Acetaminophen}
\begin{document}
\maketitle

これは\texttt{100d.pdb}というファイルをJmolでIDTF (Intermediate Data Text Format)形式に変換し、さらにU3D形式に変換して取り込んだものである。\textsf{media9} パッケージを \texttt{platex} + \texttt{dvipdfmx} で通した初めての例であろう。
    ...
    \begin{center}
        ...
        \includemedia[
            ...
            3Daac=16.260204,
            3Droll=0.0,
            3Dbg=1 1 1, % to set the background color for 3D vwr; white = 1 1 1; so, you need to do the proportion: '255:1=[RGB]:x'
            transparent=false,
            3Dlights=Headlamp,
            3Drender=Solid,
...
%  \\
%\movieref[3Dcalculate]{100d}{Click here!}
\end{center}
...
# Jmol state version 14.2.4_2014.08.03  2014-08-03 08:56;

function _setWindowState() {
# preferredWidthHeight -1 -1;
# width -1;
# height -1;
  stateVersion = 1402004;
  background [xffffff];
  axis1Color = "[xff0000]";
  axis2Color = "[x008000]";
  axis3Color = "[x0000ff]";
...
function _setFileState() {
  ...
  #set defaultDirectory "C:/PrivateLibrary/Software/Jmol";
...
function _setPerspectiveState() {
  ...
  set visualRange 5.0;
  set cameraDepth 3.0;
  boundbox corners {-10.113001 -16.765 -4.8460007} {17.116 11.232 25.439} # volume = 23087.174;
  center {3.5014997 -2.7664995 10.296499};
   moveto -1.0 {0 0 1 0} 100.0 0.0 0.0 {3.5014997 -2.7664995 10.296499} 21.83792 {0 0 0} 0 0 0 3.0 0.0 0.0;
  save orientation "default";
  moveto 0.0 {0 0 1 0} 100.0 0.0 0.0 {3.5014997 -2.7664995 10.296499} 21.83792 {0 0 0} 0 0 0 3.0 0.0 0.0;;
  slab 100;depth 0;
  set slabRange 0.0;
